...
def build_model(input_img):                                     # pre-trained vgg19 convolutional neural network
...
def minimize_with_lbfgs(sess, net, optimizer, init_img):
  if args.verbose: 
    print('\nMinimizing Loss: L-BFGS optimizer')
...
def minimize_with_adam(sess, net, optimizer, init_img, loss):
  if args.verbose: 
    print('\nMinimizing Loss: Adam optimizer')
